...
export function SectionHeading({ eyebrow, title, intro, align = 'left' }: SectionHeadingProps) {
  return (
    <div style={{ textAlign: align, maxWidth: align === 'center' ? '720px' : undefined, margin: align === 'center' ? '0 auto' : undefined }}>
      ...
      {intro && (
        <p style={{ fontSize: '18px', lineHeight: 1.6, color: 'var(--text-body)', margin: 0, maxWidth: align === 'center' ? undefined : '580px' }}>
          {intro}
        </p>
      )}
    </div>
